...
console.log("----------------");
var numRows = finances.length;
console.log("Total Months: " + numRows);

// Total number of months (numRows) = 86
...
for (var i = 1; i < finances.length; i++) {
  // Calculate the change between consecutive months
  var change = finances[i][1] - finances[i - 1][1];
// heck if the current change is the biggest decrease so far
